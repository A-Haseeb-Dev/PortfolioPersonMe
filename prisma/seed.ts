...
async function main() {
  ...
  const defaultSettings: Record<string, unknown> = {
    ...
    nav_items: [
      ...
      { label: "Resources", href: "#", children: [{ label: "Blog", href: "/blog", icon: "PenLine", description: "Articles, insights and tutorials" }, { label: "Knowledge", href: "/knowledge", icon: "Layers", description: "Documentation and guides" }, { label: "Case Studies", href: "/case-studies", icon: "FileText", description: "Real-world projects" }] },
      { label: "More", href: "#", children: [{ label: "Learning", href: "/learning", icon: "BookOpen", description: "My learning journey" }, { label: "Services", href: "/services", icon: "Sparkles", description: "What I offer" }, { label: "Achievements", href: "/achievements", icon: "Award", description: "Milestones & awards" }, { label: "Open Source", href: "/opensource", icon: "Code2", description: "Open source contributions" }, { label: "Startup Ideas", href: "/startup-ideas", icon: "Building2", description: "Ideas & validation" }, { label: "Resources", href: "/resources", icon: "FileText", description: "Downloads & guides" }] },
    ],
    stats: [
  ...
  console.log(`Created ${Object.keys(defaultSettings).length} settings`)
