  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-40 bottom-0 h-[400px] w-[400px] rounded-full bg-gradient-to-tl from-amber-200/30 to-transparent blur-3xl dark:from-amber-900/30" />
      </div>
      <motion.div variants={itemVariants} className="relative mx-auto max-w-3xl text-center">
        ...
        <p className="mt-6 text-lg leading-relaxed text-zinc-500 dark:text-zinc-400 sm:text-xl">
          Awards, certifications, and key milestones that mark the journey of continuous
          growth and impact.
        </p>
      </motion.div>
    </motion.div>
